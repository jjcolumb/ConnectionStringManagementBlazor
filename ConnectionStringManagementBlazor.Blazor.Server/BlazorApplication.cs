...
using ConnectionStringManagementBlazor.Blazor.Server.Services;

namespace ConnectionStringManagementBlazor.Blazor.Server {
    public partial class ConnectionStringManagementBlazorBlazorApplication : BlazorApplication {
        public ConnectionStringManagementBlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ConnectionStringManagementBlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
